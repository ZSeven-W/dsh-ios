...
<p align="center">
  <sub>npm: <code>@zseven-w/dsh-ios</code> &middot; Versão atual do plugin: <code>0.1.0-rc.3</code> &middot; Testado com DSH <code>0.1.1-rc.1</code></sub>
</p>
