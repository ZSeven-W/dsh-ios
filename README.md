...
<p align="center">
  <sub>npm: <code>@zseven-w/dsh-ios</code> &middot; Current plugin release: <code>0.1.0-rc.9</code> &middot; Tested with DSH <code>0.1.5-rc.1</code></sub>
</p>
